...
//            return this.module.getParent();
	...
	public final static String  iframeurl = "admin/iframe.page";
	public final static String  indexurl = "admin/index.page";
	public final static String  publicitem_url = "admin/defaultcontent";
