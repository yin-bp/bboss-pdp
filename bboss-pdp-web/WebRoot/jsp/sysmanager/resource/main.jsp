					...
					<div class="col-md-2">
						...
						<pg:list actual="${resourceTypes }">
							<li <pg:equal expression="{rowid }" value="0">class="active"</pg:equal>>
								<a data-toggle="tab" href="#tab_<pg:rowid increament="1"/>-<pg:rowid increament="1"/>">
						...
						<div class="tab-content">
								...
								<form role="form" action="#">
									...
									<div class="form-group">
										<label class="control-label">Occupation</label> <input
											type="text" placeholder="Web Developer" class="form-control" />
									</div>
									<div class="form-group">
									...
									<div class="margiv-top-10">
										<a href="javascript:;" class="btn green"> Save Changes </a> <a
							...
							<div id="tab_2-2" class="tab-pane">
								...
								<form action="#" role="form">
										...
										<div class="fileinput fileinput-new" data-provides="fileinput">
											...
											<div>
												<span class="btn default btn-file"> <span
													...
													name="...">
												</span> <a href="javascript:;" class="btn default fileinput-exists"
									...
									<div class="margin-top-10">
										<a href="javascript:;" class="btn green"> Submit </a> <a
											href="javascript:;" class="btn default"> Cancel </a>
									</div>
								</form>
							</div>
							<div id="tab_3-3" class="tab-pane">
								<form action="#">
									...
									<div class="margin-top-10">
										<a href="javascript:;" class="btn green"> Change Password
									...
									<table class="table table-bordered table-striped">
										...
										<tr>
											...
											<td>
												<div class="mt-radio-inline">
													<label class="mt-radio"> <input type="radio"
														name="optionsRadios41" value="option1" /> Yes <span></span>
													</label> <label class="mt-radio"> <input type="radio"
														name="optionsRadios41" value="option2" checked /> No <span></span>
													</label>
												</div>
											</td>
										</tr>
					...
					<div class="col-md-2">
						<ul class="ver-inline-menu tabbable margin-bottom-10">
							...
							<li><a data-toggle="tab" href="#tab_2"> <i
									class="fa fa-group"></i> Membership
							</a></li>
							<li><a data-toggle="tab" href="#tab_3"> <i
									class="fa fa-leaf"></i> Terms Of Service
							</a></li>
							<li><a data-toggle="tab" href="#tab_1"> <i
									class="fa fa-info-circle"></i> License Terms
							</a></li>
							<li><a data-toggle="tab" href="#tab_2"> <i
									class="fa fa-tint"></i> Payment Rules
							</a></li>
							<li><a data-toggle="tab" href="#tab_3"> <i
									class="fa fa-plus"></i> Other Questions
							</a></li>
						</ul>
					</div>
					<div class="col-md-10">
									...
									<div class="panel panel-default">
										...
										<div id="accordion1_2" class="panel-collapse collapse">
											<div class="panel-body">Food truck quinoa nesciunt
												...
												shoreditch et. Anim pariatur cliche reprehenderit, enim
									...
									<div class="panel panel-danger">
										...
										<div id="accordion1_5" class="panel-collapse collapse">
											<div class="panel-body">3 wolf moon officia aute, non
												...
												squid single-origin coffee nulla assumenda shoreditch et</div>
										</div>
									</div>
									<div class="panel panel-default">
										<div class="panel-heading">
										...
										<div id="accordion3_1" class="panel-collapse collapse in">
											<div class="panel-body">
												...
												<p>Anim pariatur cliche reprehenderit, enim eiusmod high
													...
													tempor, sunt aliqua put a bird on it squid single-origin
													coffee nulla assumenda shoreditch et.</p>
												<p>Food truck quinoa nesciunt laborum eiusmod. Brunch 3
													wolf moon tempor, sunt aliqua put a bird on it squid
													single-origin coffee nulla assumenda shoreditch et. Nihil
...
<script
	src="${pageContext.request.contextPath}/assets/sysmanager/sysrole.js"
