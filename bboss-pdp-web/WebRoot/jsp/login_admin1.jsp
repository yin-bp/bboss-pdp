        ...
        <div class="content">
            ...
            <form class="login-form" action="${pageContext.request.contextPath}/login.page" method="post" target="_self">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="输入账号" name="userName" id="userName"  required /> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">口令</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="输入口令" name="password" id="password"  required/> </div>
                  <div class="form-group">
                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
